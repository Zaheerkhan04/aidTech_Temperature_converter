...
public class TemperatureConverter extends JFrame
{
	...
	public void setComp()
	{
		...
		t1.setBackground(new Color(255, 240, 200));
		t1.setFont(new Font("Arial Narrow", Font.BOLD | Font.ITALIC, 15));
		...
		t2.setBackground(new Color(255, 225, 225));
		t2.setFont(new Font("Arial Narrow", Font.BOLD | Font.ITALIC, 15));
		b.setBounds(138,150,100,20);
		b.setBackground(new Color(255, 225, 225));
		ac.setBounds(238,200,50,100);
		ac.setBackground(new Color(64, 128, 128));
		pm.setBounds(238,350,50,50);
		pm.setBackground(new Color(64, 128, 128));
		bs.setBounds(238,300,50,50);
		bs.setBackground(new Color(64, 128, 128));
		dot.setBounds(188,350,50,50);
		dot.setBackground(new Color(64, 128, 128));
		n0.setBounds(88,350,100,50);
		n0.setBackground(new Color(64, 128, 128));
		n1.setBounds(88,200,50,50);
		n1.setBackground(new Color(64, 128, 128));
		n2.setBounds(138,200,50,50);
		n2.setBackground(new Color(64, 128, 128));
		n3.setBounds(188,200,50,50);
		n3.setBackground(new Color(64, 128, 128));
		n4.setBounds(88,250,50,50);
		n4.setBackground(new Color(64, 128, 128));
		n5.setBounds(138,250,50,50);
		n5.setBackground(new Color(64, 128, 128));
		n6.setBounds(188,250,50,50);
		n6.setBackground(new Color(64, 128, 128));
		n7.setBounds(88,300,50,50);
		n7.setBackground(new Color(64, 128, 128));
		n8.setBounds(138,300,50,50);
		n8.setBackground(new Color(64, 128, 128));
		n9.setBounds(188,300,50,50);
		n9.setBackground(new Color(64, 128, 128));
	...
	{
		TemperatureConverter jf = new TemperatureConverter("Temperature Converter");
		jf.setComp();
		jf.setSize(400,500);
		jf.setVisible(true);
